    ...
    <table style="width: 600px; margin: 0 auto; font-family: 'Century Gothic', Verdana, Tahoma, Arial; font-size: 17px;">
        ...
        <tr>
            <td style="padding: 30px 10px 10px 10px; border-top: 2px solid #e96656;" colspan="2">
                ...
                <br />
                <p style="padding: 0; margin: 0;">Your account for Rosie Services has been successfully created with the default password:</p>
                <br />

                <br />
                <p style="padding: 15px 10px; margin: 0; background: #e96656; color: #ffffff; text-align: center;">{{$password}}</p>
            </td>
        </tr>
